...
def main(player, floor_states):
    ...
    room_data = {'room s': {'state': 0, 'layout': 0},  # starting room
                 'room u': {'state': 0, 'layout': 0,
                            'enemy spawn':0, 'pots': 0},  # normal
                 'room uu': {'state': 0, 'layout': 0,
                            'enemy spawn': 0, 'pots': 0},  # normal
                 'room uuu': {'state': 0, 'layout': 0,
                            'enemy spawn': 0, 'pots': 0},  # normal
                 'room uur': {'state': 0, 'layout': 0,
                            'enemy spawn': 0, 'pots': 0},  # normal
                 'room uul': {'state': 0, 'layout': 0,
                              'enemy spawn': 0, 'pots': 0},  # normal
                 'room uurr': {'state': 0, 'layout': 0, 'final spawn': 0,
                               'item spawn': 0},  # final
                 'room uull': {'state': 0, 'layout': 0,
                            'enemy spawn': 0, 'pots': 0},  # normal
                 'room uulll': {'state': 0, 'layout': 0, 'item spawn': 0}}  # item
