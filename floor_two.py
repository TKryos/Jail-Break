...
def main(player, floor_states):
    ...
    room_data = {'room s': {'state': 0, 'layout': 0},  # starting room
                 'room u': {'state': 0, 'layout': random.randint(0,5),
                            'enemy spawn':random.randint(0,6), 'pots': 0},  # normal
                 'room uu': {'state': 0, 'layout': random.randint(0,5),
                            'enemy spawn': random.randint(0,6), 'pots': 0},  # normal
                 'room uuu': {'state': 0, 'layout': random.randint(0,5),
                            'enemy spawn': random.randint(0,6), 'pots': 0},  # normal
                 'room uur': {'state': 0, 'layout': random.randint(0,5),
                            'enemy spawn': random.randint(0,6), 'pots': 0},  # normal
                 'room uul': {'state': 0, 'layout': random.randint(0,5),
                              'enemy spawn': random.randint(0,6), 'pots': 0},  # normal
                 'room uurr': {'state': 0, 'layout': 0, 'final spawn': random.randint(1,6),
                               'item spawn': random.randint(0,5)},  # final
                 'room uull': {'state': 0, 'layout': random.randint(0,5),
                            'enemy spawn': random.randint(0,6), 'pots': 0},  # normal
                 'room uulll': {'state': 0, 'layout': 0, 'item spawn': random.randint(0,5)}}  # item
    ...
    while floor and player.hp > 0:
        ...
        if pygame.sprite.spritecollide(player, top_doors, False):
            ...
            if room_data['room u']['state'] == 0:
                f2_rooms.room_u0(player, room_data, floor_states)
                ...
                f2_rooms.room_u1(player, room_data, floor_states)
                ...
                f2_rooms.room_u2(player, room_data, floor_states)
