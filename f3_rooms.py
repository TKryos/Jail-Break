...
def room_ddlll2(player, room_data, floor_states):
    # Create the screen
    ...
    room_choice(floor1, room_data['room ddlll']['layout'], 0, player)
    draw_stairs(floor1)
...
def room_ddlll1(player, room_data, floor_states):
    # Create the screen
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_3")
    ...
    draw_open_boss_door_right(floor1)
    room_choice(floor1, room_data['room ddlll']['layout'], 0, player)
    item_choice(room_data['room ddlll']['item spawn'], floor1)
    draw_stairs(floor1)
    clock = pygame.time.Clock()
    TIME_SINCE_DOOR = pygame.time.get_ticks()
    ...
    while room and player.hp > 0:
        ...
        # Limit the fps
        clock.tick(30)
    if room_data['room ddlll']['state'] == 2:
        room_ddlll2(player, room_data, floor_states)


def room_ddlll0(player, room_data, floor_states):
    # Create the screen
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_3")
    ...
    room_ddlll1(player, room_data, floor_states)


def room_rrrd1(player, room_data, floor_states):
    # Create the screen
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_3")
...
def room_rrrd0(player, room_data, floor_states):
    # Create the screen
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_3")
    ...
    while room and player.hp > 0:
        ...
        # Limit the fps
        clock.tick(30)
    if room_data['room rrrd']['state'] == 1:
        room_rrrd1(player, room_data, floor_states)


def room_ddll2(player, room_data, floor_states):
    # Create the screen
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_3")
    ...
    room_choice(floor1, room_data['room ddll']['layout'], 0, player)
    clock = pygame.time.Clock()
    TIME_SINCE_DOOR = pygame.time.get_ticks()
    ...
    while room and player.hp > 0:
        ...
        if pygame.sprite.spritecollide(player, left_doors, False):
            ...
            if room_data['room ddlll']['state'] == 0:
                room_ddlll0(player, room_data, floor_states)
            ...
            elif room_data['room ddlll']['state'] == 1:
                room_ddlll1(player, room_data, floor_states)
            ...
            elif room_data['room ddlll']['state'] == 2:
                room_ddlll2(player, room_data, floor_states)
...
def room_ddll1(player, room_data, floor_states):
    # Create the screen
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_3")
    ...
    draw_right_open_door(floor1)
    room_choice(floor1, room_data['room ddll']['layout'], 0, player)
    if room_data['room ddll']['layout'] == (0 or 3 or 4):
        pots1(room_data['room ddll']['pots'], floor1)
    else:
        pots2(room_data['room ddll']['pots'], floor1)
    clock = pygame.time.Clock()
    TIME_SINCE_DOOR = pygame.time.get_ticks()
    ...
    while room and player.hp > 0:
        ...
        clock.tick(30)
    # Outside of while loop call room_state1
    if room_data['room ddll']['state'] == 2:
        room_ddll2(player, room_data, floor_states)


def room_ddll0(player, room_data, floor_states):
    # Create the screen
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_3")
    ...
    while room and player.hp > 0:
        ...
        clock.tick(30)
    # Outside of while loop call room_state1
    room_ddll1(player, room_data, floor_states)


def room_ddl2(player, room_data, floor_states):
    # Create the screen
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_3")
    ...
    draw_right_open_door(floor1)
    room_choice(floor1, room_data['room ddl']['layout'], 0, player)
    clock = pygame.time.Clock()
    TIME_SINCE_DOOR = pygame.time.get_ticks()
    ...
    while room and player.hp > 0:
        ...
        if pygame.sprite.spritecollide(player, left_doors, False):
            player.rect.center = SPRITE_RIGHT
            if room_data['room ddll']['state'] == 0:
                room_ddll0(player, room_data, floor_states)
            ...
            elif room_data['room ddll']['state'] == 1:
                room_ddll1(player, room_data, floor_states)
            ...
            elif room_data['room ddll']['state'] == 2:
                room_ddll2(player, room_data, floor_states)
...
def room_ddl1(player, room_data, floor_states):
    # Create the screen
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_3")
    ...
    draw_right_open_door(floor1)
    room_choice(floor1, room_data['room ddl']['layout'], 0, player)
    if room_data['room ddl']['layout'] == (0 or 3 or 4):
        pots1(room_data['room ddl']['pots'], floor1)
    else:
        pots2(room_data['room ddl']['pots'], floor1)
    clock = pygame.time.Clock()
    TIME_SINCE_DOOR = pygame.time.get_ticks()
    ...
    while room and player.hp > 0:
        ...
        clock.tick(30)
    # Outside of while loop call room_state1
    if room_data['room ddl']['state'] == 2:
        room_ddl2(player, room_data, floor_states)


def room_ddl0(player, room_data, floor_states):
    # Create the screen
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_3")
    ...
    while room and player.hp > 0:
        ...
        clock.tick(30)
    # Outside of while loop call room_state1
    room_ddl1(player, room_data, floor_states)
...
def room_rrr2(player, room_data, floor_states):
    ...
    while room and player.hp > 0:
        ...
        if pygame.sprite.spritecollide(player, bot_doors, False):
            ...
            if room_data['room rrrd']['state'] == 0:
                room_rrrd0(player, room_data, floor_states)
            ...
            elif room_data['room rrrd']['state'] == 1:
                room_rrrd1(player, room_data, floor_states)
...
def room_dd2(player, room_data, floor_states):
    ...
    while room and player.hp > 0:
        ...
        if pygame.sprite.spritecollide(player, left_doors, False):
            player.rect.center = SPRITE_RIGHT
            if room_data['room ddl']['state'] == 0:
                room_ddl0(player, room_data, floor_states)
            ...
            elif room_data['room ddl']['state'] == 1:
                room_ddl1(player, room_data, floor_states)
            ...
            elif room_data['room ddl']['state'] == 2:
                room_ddl2(player, room_data, floor_states)
...
def room_u2(player, room_data, floor_states):
    ...
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    floor1 = screen.copy()
    pygame.display.set_caption("Floor_23")
